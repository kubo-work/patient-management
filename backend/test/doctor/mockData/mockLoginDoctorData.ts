...
// モックデータの生成
export const mockSetDoctorData = {
...
export const testToken = sign({ userId: mockSetDoctorData.id, email: mockSetDoctorData.email }, process.env.JWT_SECRET_KEY, { expiresIn: "1d" });
